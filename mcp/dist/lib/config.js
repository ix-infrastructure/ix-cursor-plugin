...
function envChoice(name, choices, defaultVal) {
...
export const IX_HOOK_VERBOSITY = envChoice("IX_HOOK_VERBOSITY", ["silent", "brief", "verbose"], "brief");
// ── Timeouts (ms) ─────────────────────────────────────────────────────────────
...
export function timeoutFor(subcommand) {
    if (subcommand === "map")
        return TIMEOUT_MAP_MS;
